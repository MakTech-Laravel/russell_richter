...
export function ErrorBadge() {
    ...
    return (
        <div className="fixed bottom-4 right-4 z-50">
            ...
            >
                <Bug className="h-6 w-6 text-gray-900" />
                {totalCount > 0 && (
                    <span className="absolute -right-1 -top-1 flex h-6 w-6 items-center justify-center rounded-full bg-red-800 text-xs font-bold text-gray-900 ring-2 ring-white dark:ring-gray-900">
